	...
	<body>		
		...
		<div class="container" style="margin-top:70px;">		
			<form method="post" action="${pageContext.servletContext.contextPath}/agent/send">
				<fieldset>
						<legend><strong>Setup Agent: ${machine.alias}</strong></legend>
						...
						<div class="form-actions">
							...
							<a class="btn btn-danger" href="${pageContext.servletContext.contextPath}/vms/view/${machine.id}" onclick="return confirm('Are you sure want to cancel the registration?');">Cancel</a>
						</div>					  	
	  			</fieldset>
		 	</form>
	 	</div> <!-- /container -->
